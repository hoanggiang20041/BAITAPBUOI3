        ...
        private void btnEdit_Click(object sender, EventArgs e)
        {
            if (lvDetails.CheckedItems.Count > 0)
            {
                ...
                else
                {
                    ...
                    MessageBox.Show("Vui lòng sửa thông tin và nhấn 'Edit' để lưu.", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
            }
            else
            {
                MessageBox.Show("Vui lòng chọn ít nhất một mục với checkbox để sửa!", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }
        }
